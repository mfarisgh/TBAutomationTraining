...
WebUI.setText(findTestObject('Object Repository/demoblaze/Page_STORE/input_Username_loginusername'), 'eff_demo')

WebUI.setEncryptedText(findTestObject('Object Repository/demoblaze/Page_STORE/input_Password_loginpassword'), 'GklqZBguAPQ=')
